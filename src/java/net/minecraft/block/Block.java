...
import shop.xiaoda.event.misc.EventCollideWithBlock;
import shop.xiaoda.event.rendering.EventBlockRenderSide;
import shop.xiaoda.module.modules.render.XRay;
...
public class Block
{
    ...
    public boolean shouldSideBeRendered(final IBlockAccess worldIn, final BlockPos pos, final EnumFacing side) {
        if (XRay.isEnabled && XRay.blockIdList.contains(getIdFromBlock(this))) {
    ...
    public boolean shouldSideBeRendered_(final IBlockAccess worldIn, final BlockPos pos, final EnumFacing side) {
        EventBlockRenderSide event = new EventBlockRenderSide(worldIn, pos, side, this.maxX, this.minX, this.maxY, this.minY, this.maxZ, this.minZ);
    ...
    public void addCollisionBoxesToList(final World worldIn, final BlockPos pos, final IBlockState state, final AxisAlignedBB mask, final List<AxisAlignedBB> list, final Entity collidingEntity) {
        ...
        if (collidingEntity == Minecraft.getMinecraft().thePlayer) {
            final EventCollideWithBlock e = (EventCollideWithBlock) EventManager.call(new EventCollideWithBlock(this, pos, axisalignedbb));
