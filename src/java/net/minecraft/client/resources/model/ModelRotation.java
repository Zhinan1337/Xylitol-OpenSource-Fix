...
public enum ModelRotation implements IModelState, ITransformation
{
    ...
    public shop.xiaoda.utils.Matrix4f getMatrix()
    {
        return Reflector.ForgeHooksClient_getMatrix.exists() ? (shop.xiaoda.utils.Matrix4f)Reflector.call(Reflector.ForgeHooksClient_getMatrix, new Object[] {this}): new shop.xiaoda.utils.Matrix4f(this.getMatrix4d());
    }
