...
import shop.xiaoda.event.misc.EventClick;
import shop.xiaoda.event.misc.EventKey;
import shop.xiaoda.event.world.EventClickBlock;
import shop.xiaoda.event.world.EventPlace;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("X"+"YL"+"ITOL "+"FUC"+"K U LO"+"SER");
    }
    ...
    public void displayGuiScreen(final GuiScreen guiScreenIn) {
        Client.displayGuiScreen(guiScreenIn);
    }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            EventPlace eventClick = new EventPlace(this.thePlayer.inventory.currentItem);
