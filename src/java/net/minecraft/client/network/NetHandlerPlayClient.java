...
import shop.xiaoda.event.misc.EventChatReceive;
import shop.xiaoda.event.misc.EventTeleport;
import shop.xiaoda.module.modules.misc.Protocol;
import shop.xiaoda.utils.client.menu.BetterMainMenu;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient
{
    ...
    public void handleChat(S02PacketChat packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        final EventChatReceive eventChatReceive = new EventChatReceive(packetIn.getType(), packetIn.getChatComponent());
    ...
    {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.gameController);
        if (Client.instance.moduleManager.getModule(Protocol.class).getState() && Client.instance.vexviewPacket.getChannel().equals(packetIn.getChannelName())) {
            try {
                Client.instance.vexviewPacket.process(packetIn.getBufferData());
            }
            catch (IOException e) {
