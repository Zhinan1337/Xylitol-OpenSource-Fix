...
import shop.xiaoda.event.rendering.EventDrawText;
import shop.xiaoda.event.rendering.EventRender2D;
import shop.xiaoda.module.modules.movement.OldScaffold;
import shop.xiaoda.module.modules.render.PostProcessing;
import shop.xiaoda.module.modules.world.Scaffold;
import shop.xiaoda.utils.render.ScaffoldCounter;
...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        PostProcessing postProcessing = (PostProcessing)Client.instance.moduleManager.getModule((Class)PostProcessing.class);
        ...
        if (Scaffold.blockCount.getValue()) {
            switch (Scaffold.counterMode.getValue()) {
                case Simple: {
                    ScaffoldCounter.drawDefault();
                    break;
                }
                case Classic: {
                    ScaffoldCounter.drawClassic();
                    break;
                }
            }
        }
